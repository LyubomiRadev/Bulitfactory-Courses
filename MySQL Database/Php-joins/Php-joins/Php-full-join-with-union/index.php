...
$sql = <<<TAG
    ...
    FROM authors
    INNER JOIN articles
    ON authors.id = articles.author_id WHERE authors.id = 1
 ...
 * -------------------------------------------
 * Здравейте,
 * Свалете sql файла с двете таблици authors и articles. Създайте sql select join заявка
 * с която да извлечете като информация всички статии написани от автора Svetoslav Toshkin,
 * Архивирайте домашното и го изпратете на  homeworks.bulitfactory@gmail.com.
 * Успех
 */
